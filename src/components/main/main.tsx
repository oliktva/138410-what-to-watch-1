...
const Main = (props: Props): JSX.Element => {
  const {films, genres, active, onGenreChange} = props;
    ...
    <Fragment>
      <div className="visually-hidden">
        <svg xmlns="http://www.w3.org/2000/svg">
          ...
          <symbol id="pause" viewBox="0 0 14 21">
            <g id="Artboard" fill="#EEE5B5" fillRule="nonzero">
              <polygon id="Line" points="0 -1.11910481e-13 4 -1.11910481e-13 4 21 0 21" />
              <polygon id="Line" points="10 -1.11910481e-13 14 -1.11910481e-13 14 21 10 21" />
            </g>
          </symbol>
      ...
      <div className="page-content">
        <section className="catalog">
          ...
          <GenresList genres={genres} active={active} onGenreChange={onGenreChange} />
